  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="my-16 flex justify-center">
        <div dangerouslySetInnerHTML={{ __html: `
          <script src="https://pl28732098.effectivegatecpm.com/54/12/76/541276d4b5fce0f41a042b01ea43858e.js"></script>
        `}} />
      </section>
      ...
      <div className="hidden lg:block fixed top-32 right-0 z-50">
        <div dangerouslySetInnerHTML={{ __html: `
          ...
          <script src="https://www.highperformanceformat.com/4fec2a0ad6a72672d864205367950127/invoke.js"></script>
        `}} />
      </div>
