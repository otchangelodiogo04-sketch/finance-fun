...
const FEATURES = [
  {
    ...
    description: "Aprenda finanças com conteúdo prático e exemplos do dia-a-dia",
  },
  {
    icon: Trophy,
    title: "Gamificação",
    description: "Ganhe pontos, suba de rank e compete no ranking global",
  },
  {
    icon: Target,
    title: "Progressão",
    description: "Avance pelos módulos e desbloqueie novos conteúdos",
  },
  {
    icon: Users,
    title: "Para Todos",
    description: "Conteúdo adaptado para crianças, jovens e famílias",
  },
];
...
const PROFILES = [
  {
    emoji: "👶",
    title: "Criança",
    description: "Aprenda a poupar e gastar com consciência de forma divertida",
    color: "from-blue-500/20 to-cyan-500/20",
  },
  {
    emoji: "🧑",
    title: "Jovem",
    description: "Domine orçamentos, poupança e dê os primeiros passos em investimentos",
    color: "from-primary/20 to-accent/20",
  },
  {
    emoji: "👨‍👩‍👧",
    title: "Pais",
    description: "Planeamento financeiro familiar completo com gestão de stock",
      ...
      <section className="py-20 px-4 bg-card/50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Escolha o seu perfil e aprenda com conteúdo adaptado às suas necessidades
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {PROFILES.map((profile, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className={`relative overflow-hidden bg-gradient-to-br ${profile.color} border border-border rounded-2xl p-8 text-center`}
              >
        ...
        >
          <div className="bg-gradient-to-br from-primary/20 via-card to-accent/10 border border-border rounded-3xl p-8 md:p-12">
            ...
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              Junte-se a milhares de pessoas que já estão a transformar a sua relação com o dinheiro
            </p>
            <Button variant="gradient" size="xl" asChild>
              <Link to="/register">
                Criar Conta Grátis
