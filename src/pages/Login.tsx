    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <a href="https://finance-fun-pi.vercel.app/"><motion.img src={logo} alt="Finance" className="w-20 h-20 mb-4" initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.1 }} /></a>
          <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="text-3xl font-display font-bold text-gradient">Fivora</motion.h1>
